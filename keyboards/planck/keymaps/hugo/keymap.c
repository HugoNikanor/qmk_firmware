...
[_SP_DV] = { /* alt-gr of _DV, since LT doesn't support "regular" modifiers */
...
[_SP_QW_US] = {
	...
	/* Hold for CTRL, tap for ESC */
#define CTESC CTL_T(KC_ESC)
	/* Hold for Alt-GR, tap for SPACE */
#define SPAGR LT(_SP_QW_SE, KC_SPC)

[_QW_SE] = { /* Swedish QWERTY to Dvorak */
	{KC_TAB,  KC_LBRC, KC_QUOT, KC_SCLN, KC_P,    KC_Y,    KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_BSPC},
	{CTESC,   KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_ENT },
	{KC_LSFT, KC_DOT,  KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_RSFT },
	...
	{KC_LALT, KC_LEFT, KC_RGHT, KC_LGUI, MO(_LW_QW_SE), SPARG, SPARG, MO(_RS_QW_SE), KC_CAPS, KC_DOWN, KC_UP, MO(_SW)}
},
