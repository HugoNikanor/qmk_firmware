...
#define OWN  3 // Own bindings, bound to hold enter
...
// #define FORCE_NKRO
	...
	#define SPC_GR ACTION_MODS_KEY(MOD_RALT, KC_SPC)
#endif
#define SPC_GR KC_SPC
 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | TAB    |   Q  |   W  |   E  |   R  |   T  |  L1  |           |  L1  |   Y  |   U  |   I  |   O  |   P  | BSpace |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
